...
This option controls what the widget title displays.

## Mode 1: `item`

This mode sets the window title to the currently playing item's name, if applicable. (e.g., "Never Gonna Give You Up")

## Mode 2: `context`

This mode attempts to set the window title to the context from which you're currently listening to (album, artist, playlist, podcast/audiobook). If unavailable, the default "Playback Widget" title will be used.

## Mode 3: `custom`

This mode lets you use a custom window title, regardless of what's playing.

**Note:** If `preferences.custom_title` is not set, your computer username will be used.
